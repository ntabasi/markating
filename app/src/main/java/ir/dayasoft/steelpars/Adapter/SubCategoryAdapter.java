...
public class SubCategoryAdapter extends BaseAdapter {
    ...
    public SubCategoryAdapter(Context _MyContext) {
        MyContext = _MyContext;
    }

    public SubCategoryAdapter(Context _MyContext, List<Category> _data) {
        MyContext = _MyContext;
        data = _data;
    }
    ...
    public View getView(int Position, View convertView, ViewGroup parent) {
        ...
        if (rowView == null) {
            ...
            rowView = (ViewGroup) li.inflate(R.layout.list_item_subcategory ,
                    null);
